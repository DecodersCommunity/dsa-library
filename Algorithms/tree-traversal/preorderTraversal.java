...
public class preorderTraversal {
    ...
    public ArrayList<Integer> preOrder(Node myNode,ArrayList<Integer>al){
        ...
        preOrder(myNode.left,al);
        preOrder(myNode.right,al);
        return al;
    }
    public static void main(String args[]){
        ...
        ob.insert(3,"RL");
        ob.display();
        System.out.println("PRE-ORDER "+ob.preOrder());
    }
